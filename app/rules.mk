...
OPT		?= -Os
# C flags
TGT_CFLAGS	?= $(ARCH_FLAGS) $(DEBUG_FLAGS) $(OPT) $(addprefix -D, $(LIB_FLAGS)) -Wall -fno-common -ffunction-sections -fdata-sections
# C++ flags
TGT_CPPFLAGS	?= $(ARCH_FLAGS) $(DEBUG_FLAGS) $(OPT) $(addprefix -D, $(LIB_FLAGS)) -Wall -fno-common -ffunction-sections -fdata-sections
# ASM flags
